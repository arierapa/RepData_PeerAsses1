...
# Filing the NA of steps by using the mean of the 5 minute interval
data2<-data
data2$steps[is.na(data2$steps)]<-trend$steps[match(data2$interval,trend$interval)][is.na(data2$steps)]
  
# New dataset with missing value filled in
data3<-data2
...
# New factor variable with levels "weekday" and "weekend"
